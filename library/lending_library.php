...
<head>
    ...
    <style type="text/css">
        ...
        .library::before {
            border-bottom: 70px solid black; /* This will be the outer edge of the triangle */
            z-index: -1;
        }
        ...
        .library::after {
            ...
            border-bottom: 60px solid white; /* Increase the height to 60px or any desired value */
